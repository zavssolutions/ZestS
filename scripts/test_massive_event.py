...
# 1. Configuration - Use environment variables or command line arguments
API_BASE_URL = sys.argv[1] if len(sys.argv) > 1 else os.getenv("API_BASE_URL", "http://localhost:8000/api/v1")
FIREBASE_API_KEY = os.getenv("FIREBASE_API_KEY", "AIzaSyAFB00XSj9c9fvzRcIea72GEd8H_vRfz2k")
ADMIN_EMAIL = os.getenv("ADMIN_EMAIL", "sivakumar.perumalla.lld01@gmail.com")
ADMIN_PASSWORD = os.getenv("ADMIN_PASSWORD", "Ishana@1089")
...
def test_and_dump():
    ...
    print(f"\n--- [Step 1] Creating Massive Event via {API_BASE_URL} ---")
