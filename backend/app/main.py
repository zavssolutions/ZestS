...
def run_migrations():
    try:
        logger.info("Initializing database schema via SQLModel...")
        from sqlmodel import SQLModel
        import app.models  # Ensures registries are mapped
        
        # In a production environment with persistent connections, 
        # we would typically use Alembic. For this MVP migration, 
        # we use SQLModel.metadata.create_all to ensure the schema matches the code.
